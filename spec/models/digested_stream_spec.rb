...
describe DigestedStream do
  ...
  describe "#stream" do
    it "should have items in reverse chronological order" do
      d = DigestedStream.new
      d << @tweet1
      d << @tweet4
      c = Conversation.new(@tweet2, @tweet3)
  ...
  describe "#find_conversation_by_tweet" do
    ...
    it "should return nil if no conversation contains that tweet" do
  ...
  describe "#include?" do
    it "should look in tweets and conversations for a tweet" do
      d = DigestedStream.new
      d << @tweet1
      c = Conversation.new(@tweet2, @tweet3)
      d << c
